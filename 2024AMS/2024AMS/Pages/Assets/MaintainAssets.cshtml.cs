...
[BindProperties]
public class MaintainAssetsModel : PageModel
{

    private readonly _2024AMSContext _2024AMSContext;
    public MaintainAssetsModel(_2024AMSContext AMS)
    {
        _2024AMSContext = AMS;
    }
    ...
    public class JoinResult
    {
        ...
        //public string? OperatingSystem1;
    ...
    private async Task RetrieveRowsForDisplay()
    {
        ...
        JoinResultIQueryable = (
            ...
            //join o in _2024AMSContext.OperatingSystem on a.OperatingSystemID equals o.OperatingSystemID
            ...
            select new JoinResult
            {
                ...
                //OperatingSystem1 = o.OperatingSystem1,
                Asset1 = a.Asset1,
                Model = a.Model,
        ...
        if (Filter != null)
        {
            JoinResultIQueryable = JoinResultIQueryable
                ...
                || jr.Barcode.Contains(Filter) ||  jr.WarrantyDate.Value.ToString().Contains(Filter) || jr.PurchaseDate.Value.ToString().Contains(Filter));
        }
