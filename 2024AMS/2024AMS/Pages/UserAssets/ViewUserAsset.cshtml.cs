...
[BindProperties]
public class ViewUserAssetModel : PageModel
{

    private readonly _2024AMSContext _2024AMSContext;
    public ViewUserAssetModel(_2024AMSContext AMS)
    {
        _2024AMSContext = AMS;
    }
    ...
    {
        // Set the message.
        ViewData["Title"] = "View User Assets";
        if (TempData["MessageColor"] == null)
        {
            TempData["MessageColor"] = "Green";
            TempData["Message"] = "This shows the asset(s) associated with your email.";
        }
        else
        {
        ...
        UserEmailAddress = HttpContext.Session.GetString("EmailAddress");
    ...
    private async Task RetrieveRowsForDisplay()
    {
        ...
        JoinResultIQueryable = (
            ...
            }).Where(u => u.EmailAddress == UserEmailAddress);

        //// If a filter option was selected, modify the database query.
        //if (Filter != null)
        //{
        //    JoinResultIQueryable = JoinResultIQueryable
        //        .Where(jr => jr.Asset1.Contains(Filter) || jr.CheckedOutDate.Value.Equals(Filter));
        //}
